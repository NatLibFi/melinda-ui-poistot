...
export function handleFailedQueryParams(req, res, next) {
  ...
  const failedParams = [...checkPoistotQueryParams(queryParams)]
  ...
  //-----------------------------------------------------------------------------
  // Checks Poistot app specific query parameters
  //  - possible Poistot query parameters are: 
  //  - not all parameters are present in every request
  //
  function checkPoistotQueryParams(queryParams) {
    return [];
  }
